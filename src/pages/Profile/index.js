...
const Profile = () => {
    ...
    const submitHandler = () => {
        ...
        .then(res => {
            console.log(res.data)
            api.put('/users/' + res.data.id, formData, {
                headers : {
    ...
    <styled.Form >
        ...
        <styled.InputContainer >
            ...
            <WhiteInputText value={newPassword} onChange={(e) => {setNewPassword(e.target.value)}} children='Nova senha' />
            <WhiteInputText value={newpasswordConfirmation} onChange={(e) => {setNewPasswordConfirmation(e.target.value)}} children='Confirme sua senha' />
            <WhiteInputText value={password} onChange={(e) => {setPassword(e.target.value)}} children='Senha atual' />
        </styled.InputContainer>
